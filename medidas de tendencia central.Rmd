...
**Fuente: [Mediana](https://economipedia.com/definiciones/medidas-de-tendencia-central.html "Mediana")** Para obtener la **mediana**, podemos ordenar los numeros de menor a mayor, **el número que esté en medio de la muestra será la mediana.** Si utilizamos R, se puede hacer el cálculo de la mediana con la función median:
...
**4.- MODA** Es el valor que más se repite en una muestra estadística o población. No tiene fórmula en sí mismo. Lo que habría que realizar es la suma de las repeticiones de cada valor. **Fuente:[Moda](https://economipedia.com/definiciones/medidas-de-tendencia-central.html "Moda")**
